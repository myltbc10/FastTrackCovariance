...
void Fixed_Scan() {
  double r1_min_cm = 1.0, r1_max_cm = 1.0;
  double rN_min_cm = 20.0, rN_max_cm = 20.0;
  double step_cm   = 0.1;

  double minSpacing_cm = 0.5;
  int samplesPerConfig = 500000;
  ...
  std::string csvOut  = "results/csvs/fixed_bound.csv";
  std::string geomDir = "results/geometries/fixed_bound";
